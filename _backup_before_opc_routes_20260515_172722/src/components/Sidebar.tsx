...
export default function Sidebar({ currentPath, userRole = 'client', userName = 'User', userEmail = '' }: SidebarProps) {
  ...
  const getNavigationItems = () => {
    const baseItems = [
      { label: 'Dashboard', href: `${baseUrl}/miraka-co-portal`, icon: 'home' },
    ...
    baseItems.push({ label: 'Profile Settings', href: `${baseUrl}/miraka-co-portal/client/profile`, icon: 'settings' });
  ...
  const isActive = (href: string) => {
    ...
    if (normalizedHref === '/miraka-co-portal' && normalizedPath === '/miraka-co-portal') {
      return true;
    }
    
    if (normalizedHref !== '/miraka-co-portal' && normalizedPath.startsWith(normalizedHref)) {
      return true;
    }
          ...
          >
            ...
            {isMobileExpanded && (
              <>
                ...
                {/* Logout Button */}
                <a
                  href={`${baseUrl}/miraka-co-portal/logout`}
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: '12px',
