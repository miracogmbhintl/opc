...
if (
  !astroConfig.includes('OPC_VIEW_TRANSITION_COMPAT_V2') &&
  !astroConfig.includes('OPC_WORKABILITY_VIEW_TRANSITION_COMPAT_V2')
) failures.push('astro.config.mjs: missing supported OPC view-transition runtime guard');
if (
  !astroConfig.includes("typeof transitionInput.update === 'function'") &&
  !astroConfig.includes("typeof input.update === 'function'")
