...
export const GET: APIRoute = async ({ locals }) => {
  const envCheck = {
    ...
    public: {
      PUBLIC_SUPABASE_URL: {
        runtime: !!import.meta.env.PUBLIC_SUPABASE_URL,
      ...
      PUBLIC_SUPABASE_ANON_KEY: {
        runtime: !!import.meta.env.PUBLIC_SUPABASE_ANON_KEY,
      ...
      WEBFLOW_API_HOST: {
        runtime: !!import.meta.env.WEBFLOW_API_HOST,
        importMeta: !!import.meta.env.WEBFLOW_API_HOST,
        value: import.meta.env.WEBFLOW_API_HOST || import.meta.env.WEBFLOW_API_HOST || 'MISSING'
      }
    },
    secrets: {
      SUPABASE_SERVICE_ROLE_KEY: {
        runtime: !!import.meta.env.SUPABASE_SERVICE_ROLE_KEY,
        importMeta: !!import.meta.env.SUPABASE_SERVICE_ROLE_KEY,
        length: (import.meta.env.SUPABASE_SERVICE_ROLE_KEY || import.meta.env.SUPABASE_SERVICE_ROLE_KEY || '').length
      },
      SUPABASE_SERVICE_ROLE: {
        runtime: !!import.meta.env.SUPABASE_SERVICE_ROLE,
        importMeta: !!import.meta.env.SUPABASE_SERVICE_ROLE,
        length: (import.meta.env.SUPABASE_SERVICE_ROLE || import.meta.env.SUPABASE_SERVICE_ROLE || '').length
      },
      WEBFLOW_SITE_API_TOKEN: {
        runtime: !!import.meta.env.WEBFLOW_SITE_API_TOKEN,
        importMeta: !!import.meta.env.WEBFLOW_SITE_API_TOKEN,
        length: (import.meta.env.WEBFLOW_SITE_API_TOKEN || import.meta.env.WEBFLOW_SITE_API_TOKEN || '').length
      },
      WEBFLOW_CMS_SITE_API_TOKEN: {
        runtime: !!import.meta.env.WEBFLOW_CMS_SITE_API_TOKEN,
        importMeta: !!import.meta.env.WEBFLOW_CMS_SITE_API_TOKEN,
        length: (import.meta.env.WEBFLOW_CMS_SITE_API_TOKEN || import.meta.env.WEBFLOW_CMS_SITE_API_TOKEN || '').length
      },
      OWNER_MOD_KEY: {
        runtime: !!import.meta.env.OWNER_MOD_KEY,
        importMeta: !!import.meta.env.OWNER_MOD_KEY,
        length: (import.meta.env.OWNER_MOD_KEY || import.meta.env.OWNER_MOD_KEY || '').length
      }
    },
    diagnosis: {
