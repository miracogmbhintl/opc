  ...
  return (
    ...
    >
      <span style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0 }}>
        <span style={{ width: 42, height: 42, borderRadius: 14, display: 'grid', placeItems: 'center', background: '#FFFFFF', border: '1px solid #E5E7EB', flexShrink: 0 }}>
          <ReceiptText size={18} />
        </span>
        <span style={{ display: 'grid', gap: 3, minWidth: 0 }}>
          <strong style={{ fontSize: 15 }}>Bereit zur Verrechnung</strong>
          <span style={{ color: '#6B7280', fontSize: 12, fontWeight: 650 }}>
            {count === 1 ? '1 abgeschlossener Einsatz wartet auf Freigabe' : `${count} abgeschlossene Einsätze warten auf Freigabe`}
          </span>
        </span>
      </span>
